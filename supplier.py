...
class supplierclass:
    def __init__(self,root):
        ...
        txt_search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",10),bg="lightyellow").place(x=800,y=80,width=150)

        btn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",10),bg="green",cursor="hand2").place(x=980,y=79,width=100,height=28)
        ...
        #=================row1================
        lbl_supplier_invoice=Label(self.root,text="Invoice ID",font=("goudy old style",15),bg="white").place(x=50,y=80)
        ...
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15),bg="lightyellow").place(x=180,y=120)
        


        #==============================row3==============================
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15),bg="white").place(x=50,y=160)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15),bg="lightyellow").place(x=180,y=160)

        #===============================row4===============================
        '''
        lbl_desc=Label(self.root,text="Description",font=("goudy old style",15),bg="white").place(x=50,y=200)
        txt_desc=Text(self.root,font=("goudy old style",15),bg="lightyellow").place(x=180,y=200,width=470,height=120)
        '''

        #===================button=======================

        btn_add=Button(self.root,text="ADD",command=self.add,font=("goudy old style",10),bg="green",fg="white",cursor="hand2").place(x=50,y=370,width=150,height=35)
        btn_update=Button(self.root,text="UPDATE",command=self.update,font=("goudy old style",10),bg="#2196f3",fg="white",cursor="hand2").place(x=200,y=370,width=150,height=35)
        btn_delete=Button(self.root,text="DELETE",command=self.delete,font=("goudy old style",10),bg="red",fg="white",cursor="hand2").place(x=350,y=370,width=150,height=35)
        btn_clear=Button(self.root,text="CLEAR",command=self.clear,font=("goudy old style",10),bg="grey",fg="white",cursor="hand2").place(x=490,y=370,width=150,height=35)
