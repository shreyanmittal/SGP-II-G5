...
class medicineclass:
    def __init__(self,root):
        ...
        #================options===============\
        '''
        cmb_search=ttk.Combobox(SearchFrame,textvariable=self.var_searchby,values= ("Select","Name","Type","Company","Medicine ID"),state="readonly",justify=CENTER)
        ...
        #============================title============================
        title=Label(self.root,text="Medicine details",font=("goudy old style",15),bg="dark blue",fg="white").place(x=50,y=100,width=1000)


        #========================content======================

        #=================row1================
        lbl_med_id=Label(self.root,text="Medicine ID",font=("goudy old style",15),bg="white").place(x=50,y=150)
        lbl_med_type=Label(self.root,text="Type",font=("goudy old style",15),bg="white").place(x=450,y=150)
        lbl_med_company=Label(self.root,text="Company",font=("goudy old style",15),bg="white").place(x=750,y=150)


        txt_med_id=Entry(self.root,textvariable=self.var_med_id,font=("goudy old style",15),bg="lightyellow").place(x=170,y=150,width=180)
        ...
        txt_med_company=Entry(self.root,textvariable=self.var_med_company,font=("goudy old style",15),bg="lightyellow").place(x=850,y=150,width=180)



        #=================row2================
        lbl_med_name=Label(self.root,text="Name",font=("goudy old style",15),bg="white").place(x=50,y=250)
        lbl_med_quantity=Label(self.root,text="Quantity",font=("goudy old style",15),bg="white").place(x=450,y=250)
        lbl_med_price=Label(self.root,text="Price",font=("goudy old style",15),bg="white").place(x=790,y=250)


        txt_med_name=Entry(self.root,textvariable=self.var_med_name,font=("goudy old style",15),bg="lightyellow").place(x=110,y=250)
        txt_med_quantity=Entry(self.root,textvariable=self.var_med_quantity,font=("goudy old style",15),bg="lightyellow").place(x=540,y=250)
        txt_med_price=Entry(self.root,textvariable=self.var_med_price,font=("goudy old style",15),bg="lightyellow").place(x=850,y=250)


        #==============================row3==============================
        lbl_med_mandate=Label(self.root,text="Manufacturing Date",font=("goudy old style",15),bg="white").place(x=50,y=350)
        lbl_med_expdat=Label(self.root,text="Expiry Date",font=("goudy old style",15),bg="white").place(x=450,y=350)
      

        txt_med_mandate=Entry(self.root,textvariable=self.var_med_mandate,font=("goudy old style",15),bg="lightyellow").place(x=220,y=350)
        txt_med_expdate=Entry(self.root,textvariable=self.var_med_expdate,font=("goudy old style",15),bg="lightyellow").place(x=550,y=350)

        #===================button=======================

        btn_add=Button(self.root,text="ADD",command=self.add,font=("goudy old style",10),bg="grey",fg="white",cursor="hand2").place(x=50,y=400,width=150,heigh=30)
        btn_update=Button(self.root,text="UPDATE",command=self.update,font=("goudy old style",10),bg="light blue",fg="black",cursor="hand2").place(x=200,y=400,width=150,height=30)
        btn_delete=Button(self.root,text="DELETE",command=self.delete,font=("goudy old style",10),bg="red",fg="white",cursor="hand2").place(x=350,y=400,width=150,height=30)
        btn_clear=Button(self.root,text="CLEAR",command=self.clear,font=("goudy old style",10),bg="green",fg="white",cursor="hand2").place(x=500,y=400,width=150,height=30)
